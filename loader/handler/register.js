...
define(["dojo/request/handlers",
	...
	register.getHandler = function (name) {
		// summary:
		//		Get a registered handler by name.
		// name: String?
		//		Name of the handler.
		// returns: handler | Object
		//		A data handler or, if name is omitted, an array of all registered
		//		handler names.
		// tag:
		//		public
		return name ? registry[name] : Object.keys(registry);
	};
